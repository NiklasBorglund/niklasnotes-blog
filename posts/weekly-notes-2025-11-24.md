...
## Solo Leveling: ARISE OVERDRIVE by Netmarble Neo
...
## Mount & Blade II: Bannerlord - War Sails by TaleWorlds Entertainment
...
## Of Ash and Steel by Fire & Frost
...
## Project Motor Racing by Straight4Studios & Giants Software
...
## BLACK SOULS II by Eeny, meeny, miny, moe?
...
* [Storage Hunter Simulator](https://niklasnotes.com/dashboard/game/68230/storage_hunter_simulator) - A simulation game where players bid on storage lockers. Players love that the developers are very responsive to community feedback. They like the auction and pawn shop mechanics and the general concept of the game. Many players mention game bugs and performance issues that severely detracts from the experience. Many also feel like the game becomes repetitive after a while.
```condensedgamecard
{
"gameId": "68230"
}
```
* [Noobs Are Coming](https://niklasnotes.com/dashboard/game/66142/noobs_are_coming) - An arena roguelike game. Players compare it often to Brotato, often thinking it improved on its formula. They like the amount of characters and the sheer replayability of the game. A lot of players have faced technical issues and some players have mixed opinions on difficulty balance and unlockable content.
```condensedgamecard
{
"gameId": "66142"
}
...
```minigamecardlist
["224740", "93596", "12533", "123750", "216250", "157752", "48839", "200928", "114186", "184167", "145599", "236629", "233025", "242819", "245176"]
```

---


## Full List: Top Releases for November 24 - November 30 (2025)

```customlist
{
  "listName": "top-releases-week-2025-11-24_to_2025-11-30",
  "visibleColumns": ["impactScore", "index", "positivePercentageScore", "totalReviews", "estPlayTime", "age"]
}
```
---

## BONUS: Top Releases for all of November

Since it's a new month, here's the full list for all the top games in November

```customlist
{
  "listName": "top-releases-2025-11",
  "visibleColumns": ["impactScore", "index", "positivePercentageScore", "totalReviews", "estPlayTime", "age"]
}
```
